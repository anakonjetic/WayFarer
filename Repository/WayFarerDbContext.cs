...
namespace WayFarer.Repository
{
    public class WayFarerDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Review>().HasData(new Review { Id = 1, Comment = "Najbolje mjesto u gradu, uživali smo u noći pjesnika!", Rating = 5, CityId = 1, AttractionId = 1, UserId = 1});
